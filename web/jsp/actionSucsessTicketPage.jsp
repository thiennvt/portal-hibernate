<%-- 
    Document   : actionSucsessTicketPage
    Created on : May 24, 2017, 9:40:13 PM
    Author     : THIEN-NVT
--%>
            ...
            <jsp:include page="homeAdminClient_HeaderAndMenu.jsp"></jsp:include>
                <div class="content-wrapper">
                    <section class="content">
                        ...
                        <h4 class="text-center" style="color: #1087dd"><a href="<c:url value="/ticket/getAllTicket.htm?companyId=${sessionScope.id}"/>">Show List Tickets</a></h4>
                </section>
                <!-- /.content -->
            </div>
            <!-- /.content-wrapper -->
