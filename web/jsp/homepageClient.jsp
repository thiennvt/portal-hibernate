            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="<c:url value="/ticket/showSearchTicket.htm"/>">Kiểm tra vé</a></li>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div id="carousel-id" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item">
                                <img data-src="holder.js/900x500/auto/#777:#7a7a7a/text:First slide" alt="First slide" src="<c:url value="/images/2.jpg"/>">
                            </div>
                            <div class="item">
                                <img data-src="holder.js/900x500/auto/#777:#7a7a7a/text:First slide" alt="First slide" src="<c:url value="/images/2.jpg"/>">
                            </div>
                            <div class="item active">
                                <img data-src="holder.js/900x500/auto/#777:#7a7a7a/text:First slide" alt="First slide" src="<c:url value="/images/4.jpg"/>">
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <ul class="danhSachChuyen">
                            <li class="Chuyen1">
                                ...
                                <span class="gia" style="font-size: 18px;font-weight: bold;color: red;padding-top: 5px">${schedule.company.name}</span><br>
