<%-- 
    Document   : actionSucsessSchedulePage
    Created on : May 23, 2017, 10:01:07 PM
    Author     : THIEN-NVT
--%>
            ...
            <jsp:include page="homeAdminClient_HeaderAndMenu.jsp"></jsp:include>
                <div class="content-wrapper">
                    <section class="content">
                        ...
                        <h4 class="text-center" style="color: #1087dd"><a href="<c:url value="/schedule/getAllSchedule.htm?companyId=${sessionScope.id}"/>">Show List Schedule</a></h4>
                </section>
                <!-- /.content -->
            </div>
            <!-- /.content-wrapper -->
